                        ...
                        <div class="support-btn-main clearfix-div">
                            ...
                            <div class="qc-column-12">
                                ...
                                <div class="support-btn">
                                    ...
                                    <a class="premium-support premium-support-width" href="https://www.quantumcloud.com/resources/kb-sections/portfolio-x/" target="_blank">Online KnowledgeBase</a>
                                </div>
...
$instance_pdf_suport = new QcPDSupportAndPromoPage('qcpx_portfolio-qcld-support');

if( is_admin() )
{
	$instance_pdf_suport->plugin_menu_slug = "edit.php?post_type=qcpx_portfolio";
