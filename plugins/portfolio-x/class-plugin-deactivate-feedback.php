...
if( ! class_exists( 'PortX_Usage_Feedback') ) {
	
	class PortX_Usage_Feedback {
		...
		public function filter_action_links( $links ) {
			...
			if( isset( $links['deactivate'] ) && $this->include_goodbye_form ) {
				...
				$deactivation_link = str_replace( '<a ', '<div class="wpb-goodbye-form-wrapper"><span class="wpb-goodbye-form" id="wpb-goodbye-form-' . esc_attr( $this->plugin_name ) . '"></span></div><a onclick="javascript:event.preventDefault();" id="wpb-portx-goodbye-link-' . esc_attr( $this->plugin_name ) . '" ', $deactivation_link );
		...
		public function goodbye_ajax() {
			...
			<script>
				jQuery(document).ready(function($){
					...
					$("#wpb-portx-goodbye-link-<?php echo esc_attr( $this->plugin_name ); ?>").on("click",function(){
						// We'll send the user to this deactivation link when they've completed or dismissed the form
						var url = document.getElementById("wpb-portx-goodbye-link-<?php echo esc_attr( $this->plugin_name ); ?>");
