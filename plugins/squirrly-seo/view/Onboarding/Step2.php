                                    ...
                                    <div class="col-12 my-2 px-2 pt-3">
                                        <div id="checkbox1" class="checkbox my-2">
                                            <label>
                                                ...
                                                <?php echo sprintf(esc_html__("Getting %s SEO Automation %s ready on your WP", _SQ_PLUGIN_NAME_),'<strong style="color:#f97517">','</strong>'); ?>
                                            </label>
                                        </div>
                                        ...
                                        <div id="checkbox2" class="checkbox my-2">
                                            <label>
                                                <input type="checkbox" value="" disabled>
                                                <span class="cr"><i class="cr-icon fa fa-check"></i></span>
                                                <?php echo sprintf(esc_html__("Activating %s SEO METAs %s", _SQ_PLUGIN_NAME_),'<strong style="color:#f97517">','</strong>'); ?>
                                            </label>
                                        </div>
                                        ...
                                        <div id="checkbox3" class="checkbox my-2">
                                            <label>
                                                <input type="checkbox" value="" disabled>
                                                <span class="cr"><i class="cr-icon fa fa-check"></i></span>
                                                <?php echo sprintf(esc_html__("Activating %s JSON-LD Schema %s", _SQ_PLUGIN_NAME_),'<strong style="color:#f97517">','</strong>'); ?>
                                            </label>
                                        </div>
                                        ...
                                        <div id="checkbox4" class="checkbox my-2">
                                            <label>
                                                <input type="checkbox" value="" disabled>
                                                <span class="cr"><i class="cr-icon fa fa-check"></i></span>
                                                <?php echo sprintf(esc_html__("Activating %s Open Graph %s", _SQ_PLUGIN_NAME_),'<strong style="color:#f97517">','</strong>'); ?>
                                            </label>
                                        </div>
                                        ...
                                        <div id="checkbox5" class="checkbox my-2">
                                            <label>
                                                <input type="checkbox" value="" disabled>
                                                <span class="cr"><i class="cr-icon fa fa-check"></i></span>
                                                <?php echo sprintf(esc_html__("Activating %s Twitter Cards %s", _SQ_PLUGIN_NAME_),'<strong style="color:#f97517">','</strong>'); ?>
                                            </label>
                                        </div>
                                        ...
                                        <div id="checkbox6" class="checkbox my-2">
                                            <label>
                                                <input type="checkbox" value="" disabled>
                                                <span class="cr"><i class="cr-icon fa fa-check"></i></span>
                                                <?php echo sprintf(esc_html__("Creating your %s Sitemap XML %s", _SQ_PLUGIN_NAME_),'<strong style="color:#f97517">','</strong>'); ?>
                                            </label>
                                        </div>
                                        ...
                                        <div id="checkbox7" class="checkbox my-2">
                                            <label>
                                                <input type="checkbox" value="" disabled>
                                                <span class="cr"><i class="cr-icon fa fa-check"></i></span>
                                                <?php echo sprintf(esc_html__("Creating %s Robots.txt %s", _SQ_PLUGIN_NAME_),'<strong style="color:#f97517">','</strong>'); ?>
                                            </label>
                                        </div>
